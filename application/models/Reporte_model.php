...
class Reporte_model extends CI_Model
{
    ...
    {
        $this->db->select('
            (SELECT numeroTienda FROM marca WHERE idMarca=10) AS nombre1,
            ...
            (SELECT numeroTienda FROM marca WHERE idMarca=7) AS nombre2,
            ...
            (SELECT numeroTienda FROM marca WHERE idMarca=9) AS nombre3,
            ...
            (SELECT numeroTienda FROM marca WHERE idMarca=6) AS nombre4,
    ...
    {
        $this->db->select("COUNT(idProducto)  as cantidad ,numeroTienda as marca
        FROM producto 
